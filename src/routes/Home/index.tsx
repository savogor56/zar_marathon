...
export const HomePage: React.FC<Props> = ({onChangePage}) => {
  const handleStartGame = (page: string) => {
  ...
  return (
    <>
      <MenuHeader />
      <Header title="This is title" descr="This is Description!" onStartGame={handleStartGame} />
